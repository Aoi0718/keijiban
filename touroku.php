    ...
    <div class="container">
        ...
        <div class="border">
            <form method="POST" action="exec_touroku.php">
                <p>ログインID:<input type="text" name="id" pattern="^[a-zA-Z0-9]+$+@" pattern=".*\S+.*" required placeholder="30文字以内"></p>
                <p>パスワード:<input type="password" name="pass" pattern="^[a-zA-Z0-9]+$" pattern=".*\S+.*" required placeholder="30文字以内"></p>
